...
<c:if test="${f:length(data.content) == 0}">
    ...
    <a class="btn btn-primary" href="/cua-hang/create">Thêm mới</a>
...
<c:if test="${f:length(data.content) != 0}">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <h1 style="align-items: center">Quản lý Cửa Hàng</h1>
            </div>
        </div>
        <a class="btn btn-primary" href="/cua-hang/create">Thêm mới</a>
        <table class="table">
            ...
            <c:forEach items="${ data.content }" var="ch">
                <tr>
                    ...
                    <td>${ ch.quocGia }</td>
                    <td>
                        <a class="btn btn-warning" href="/cua-hang/edit/${ch.id}">Cập nhật</a>
                        <a class="btn btn-danger" href="/cua-hang/delete/${ch.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
