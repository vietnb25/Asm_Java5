...
<c:if test="${f:length(data.content) == 0}">
    ...
    <a class="btn btn-primary" href="/san-pham/create">Thêm mới</a>
</c:if>
...
<c:if test="${f:length(data.content) != 0}">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <h1 style="align-items: center">Quản lý Sản Phẩm</h1>
            </div>
        </div>
        <a class="btn btn-primary" href="/san-pham/create">Thêm mới</a>
        <table class="table">
            ...
            <c:forEach items="${data.content}" var="sp">
                <tr>
                    ...
                    <td>${ sp.ten }</td>
                    <td>
                        <a class="btn btn-warning" href="/san-pham/edit/${sp.id}">Cập nhật</a>
                        <a class="btn btn-danger" href="/san-pham/delete/${sp.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
                    </td>
